...
(while true; do /usr/lib/keymaster-avatar/km-ssh-sa --log-level debug || true; sleep 1; done) &
(while true; do /usr/lib/keymaster-avatar/km-gpg-sa --log-level debug || true; sleep 1; done) &
(while true; do /usr/lib/keymaster-avatar/km-nostr-sa --log-level debug || true; sleep 1; done) &
